...
(def by-id
{"37212c12-1aeb-4fd9-aa43-b283e911af61"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "37212c12-1aeb-4fd9-aa43-b283e911af61",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger :paladin},
  :range :self},
 "d562c3d3-a03f-4935-8963-289f699f9321"
 {:description
  ...
  :components "VM",
  :ritual "no",
  :id "d562c3d3-a03f-4935-8963-289f699f9321",
  :casting-time "1 action",
  :material-components "bat fur and a drop of pitch or piece of coal",
  :classes #{:sorcerer :wizard :warlock},
  :range 60},
 "f8c7fe96-1223-442d-9914-a70099bae51d"
 {:school :evocation,
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "f627c3de-cf62-48d2-8098-859758a12a6c",
  :casting-time "1 action",
  :classes #{:cleric},
  :range :touch},
 "ecdbef31-d9b6-4875-8e48-6f6558773b56"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ecdbef31-d9b6-4875-8e48-6f6558773b56",
  :casting-time "1 action",
  :classes #{:cleric :wizard :bard},
  :range :unlimited},
 "d795e87b-d5db-41a7-b970-6cfccb84e782"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "d795e87b-d5db-41a7-b970-6cfccb84e782",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger},
  :range 120},
 "c0724629-3039-4028-8a68-cf1760566be9"
 {:school :abjuration,
  :name "Aura of Purity",
  :concentration true,
  :duration "Concentration, up to 10 minutes",
  ...
  :components "V",
  :ritual "no",
  :id "c0724629-3039-4028-8a68-cf1760566be9",
  :casting-time "1 action",
  :classes #{:paladin},
  :range :self},
 "4c886cec-114f-4710-8789-d11df629a675"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "4c886cec-114f-4710-8789-d11df629a675",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 60},
 "5b9d7303-ba89-4f91-90b5-f6892adc763c"
 {:school :enchantment,
  ...
  :components "VS",
  :ritual "no",
  :id "5b9d7303-ba89-4f91-90b5-f6892adc763c",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 120},
 "4ab519a0-28b1-4114-9b7b-77f3c5afc4ec"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "4ab519a0-28b1-4114-9b7b-77f3c5afc4ec",
  :casting-time "10 minutes",
  :classes #{:paladin},
  :range 30},
 "5f44e4ba-ecf5-4132-adaa-0b740ef51e2c"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "5f44e4ba-ecf5-4132-adaa-0b740ef51e2c",
  :casting-time "1 action",
  :classes #{:cleric :paladin},
  :range 60},
 "0cce1793-bed5-4504-8fa4-5a899f14d796"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "0cce1793-bed5-4504-8fa4-5a899f14d796",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 60},
 "7054c169-ee48-4fb9-b2b7-b712b92dc02d"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "7054c169-ee48-4fb9-b2b7-b712b92dc02d",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger :sorcerer :paladin},
  :range 60},
 "c113c453-ea97-49c4-864a-608cbdf5237f"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "c113c453-ea97-49c4-864a-608cbdf5237f",
  :casting-time "1 action",
  :classes #{:warlock},
  :range 120},
 "6b4a5166-7812-42f9-b598-a90fc55dda72"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "6b4a5166-7812-42f9-b598-a90fc55dda72",
  :casting-time "1 action",
  :classes #{:paladin :bard},
  :range :touch},
 "63732a3a-a998-4ddb-902d-7bd9524621f5"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "63732a3a-a998-4ddb-902d-7bd9524621f5",
  :casting-time "1 bonus action",
  :classes #{:cleric},
  :range 30},
 "27647da2-30db-4d3e-a4fd-840a607fb635"
 {:description "The next time you hit a creature with a weapon attack before this spell ends, a writhing mass of thorny vines appears at the point of impact, and the target must succeed on a Strength saving throw or be restrained by the magical vines until the spell ends. A Large or larger creature has advantage on this saving throw. If the target succeeds on the save, the vines shrivel away.\n\nWhile restrained by this spell, the target takes 1d6 piercing damage at the start of each of its turns. A creature restrained by the vines or one of that can touch the creature can use its action to make a Strength check against your spell save DC. On a success, the target is freed.\n\n**_At Higher Levels_**. If you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d6 for each slot level above 1st."
  :school :conjuration,
  ...
  :components "V",
  :ritual "no",
  :id "27647da2-30db-4d3e-a4fd-840a607fb635",
  :casting-time "1 bonus action",
  :classes #{:ranger},
  :range :self},
 "cf5dbb74-98cc-4e63-a679-fd1fe3171d27"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "cf5dbb74-98cc-4e63-a679-fd1fe3171d27",
  :casting-time "1 action",
  :material-components "a bit of fleece",
  :classes #{:sorcerer :wizard :bard},
  :range 60},
 "881a13df-5980-4829-a927-cf92254bd7f1"
 {:school :evocation,
  ...
  :components "V",
  :ritual "no",
  :id "881a13df-5980-4829-a927-cf92254bd7f1",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "bcfa047d-226f-4948-9093-f401f5074d6c"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "bcfa047d-226f-4948-9093-f401f5074d6c",
  :casting-time "10 minutes",
  :classes #{:cleric},
  :range 60},
 "cfe79d92-b7f4-4674-92f4-c3f05cb5f35f"
 {:school :transmutation,
  :name "Earthbind",
  :concentration true,
  ...
  :components "V",
  :ritual "no",
  :id "cfe79d92-b7f4-4674-92f4-c3f05cb5f35f",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range 300},
 "becf3a5e-b69a-4a4a-bdb1-004e6c6ea2eb"
 {:school :evocation,
  ...
  :components "VSM",
  :ritual "no",
  :id "becf3a5e-b69a-4a4a-bdb1-004e6c6ea2eb",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 30},
 "718ef92e-bea5-400f-991a-37795aa9519b"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "718ef92e-bea5-400f-991a-37795aa9519b",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger :sorcerer},
  :range 30},
 "9e4fd9e2-b3dd-482c-be75-894e8b9fe2b8"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "9e4fd9e2-b3dd-482c-be75-894e8b9fe2b8",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 120},
 "d3a59ad9-d394-4929-9c8f-49f596b6c3fb"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "d3a59ad9-d394-4929-9c8f-49f596b6c3fb",
  :casting-time "1 minute",
  :material-components "a hummingbird feather",
  :classes #{:druid :wizard :warlock :bard},
  :range :touch},
 "4409004a-d093-440b-90ea-a8b4c6211c7b"
 {:school :transmutation,
  :name "Control Winds",
  :concentration true,
  ...
  :components "VS",
  :ritual "no",
  :id "4409004a-d093-440b-90ea-a8b4c6211c7b",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 300},
 "59a4a243-ee38-4ebd-ad3f-97f4dd3c043c"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "59a4a243-ee38-4ebd-ad3f-97f4dd3c043c",
  :casting-time "1 action",
  :classes #{:cleric :druid :bard},
  :range 60},
 "b98f1fb2-a650-4a3a-ab44-b41f98360f9f"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b98f1fb2-a650-4a3a-ab44-b41f98360f9f",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 90},
 "3cd2279f-cb96-4a06-9f26-0d2c6b2684a8"
 {:school :evocation,
  :name "Telepathy",
  :concentration false,
  :duration "24 hours",
  ...
  :components "VSM",
  :ritual "no",
  :id "3cd2279f-cb96-4a06-9f26-0d2c6b2684a8",
  :casting-time "1 action",
  :classes #{:wizard},
  :range :unlimited},
 "5d151d1a-fd29-43c9-b8ef-cc69b597af74"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "5d151d1a-fd29-43c9-b8ef-cc69b597af74",
  :casting-time "1 action",
  :classes #{:druid},
  :range 30},
 "f4cf387d-e45c-4a34-9c54-d561667cce3b"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "f4cf387d-e45c-4a34-9c54-d561667cce3b",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 120},
 "9c37dd69-b8b9-45f8-9149-f2fc1793cf82"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "9c37dd69-b8b9-45f8-9149-f2fc1793cf82",
  :casting-time "1 hour",
  :material-components
  ...
  :range 10},
 "a4999e6e-f749-41ca-918c-97fde9cadf81"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "a4999e6e-f749-41ca-918c-97fde9cadf81",
  :casting-time "1 action",
  :material-components "a diamond worth at least 5,000 gp",
  :classes #{:cleric :sorcerer :wizard},
  :range 60},
 "a5de589f-35d3-4e77-9540-df100e7730e3"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "a5de589f-35d3-4e77-9540-df100e7730e3",
  :casting-time "1 action",
  :material-components "a drop of bitumen and a spider",
  :classes #{:sorcerer :wizard :warlock},
  :range :touch},
 "285e5b36-c5d6-4b82-8e4f-495626478e16"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "285e5b36-c5d6-4b82-8e4f-495626478e16",
  :casting-time "1 action",
  :classes #{:druid},
  :range 90},
 "c934f45d-7108-4836-b76e-f2004e24d29b"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "c934f45d-7108-4836-b76e-f2004e24d29b",
  :casting-time "1 action",
  :material-components "a pinch of dust and a few drops of water",
  :classes #{:druid :sorcerer :wizard},
  :range 300},
 "cf3607d5-f7a0-4cbf-a6b1-ab508802f6f3"
 {:school :evocation,
  :name "Blinding Smite",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "V",
  :ritual "no",
  :id "cf3607d5-f7a0-4cbf-a6b1-ab508802f6f3",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "2b37c1a9-ea83-49a1-8e00-a37e61c25cf8"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "2b37c1a9-ea83-49a1-8e00-a37e61c25cf8",
  :casting-time "1 action",
  :material-components
  "a bit of fur and a rod of amber, crystal, or glass",
  :classes #{:sorcerer :wizard},
  :range :self},
 "c402eaf1-e8b9-47ee-9a3b-979f49ed2df4"
 {:description
  ...
  :components "S",
  :ritual "no",
  :id "c402eaf1-e8b9-47ee-9a3b-979f49ed2df4",
  :casting-time "1 action",
  :classes #{:wizard :bard},
  :range :self},
 "16e3fee5-3394-4485-b3c8-06f083f5a978"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "16e3fee5-3394-4485-b3c8-06f083f5a978",
  :casting-time "1 action",
  :material-components "a piece of cured leather",
  :classes #{:sorcerer :wizard},
  :range :touch},
 "d2a5cc70-7ba2-46d7-b4d9-4127215277c0"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "d2a5cc70-7ba2-46d7-b4d9-4127215277c0",
  :casting-time "1 action",
  :classes #{:wizard},
  :range :touch},
 "5e5c66d1-5ece-485e-bac6-9fdb0b3ae959"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "5e5c66d1-5ece-485e-bac6-9fdb0b3ae959",
  :casting-time "1 action",
  :classes #{:cleric :wizard},
  :range :touch},
 "9a88bb5f-6db2-40ec-bdd4-fdd552951c66"
 {:school :conjuration,
  :name "Tidal Wave",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VSM",
  :ritual "no",
  :id "9a88bb5f-6db2-40ec-bdd4-fdd552951c66",
  :casting-time "1 action",
  :classes #{:druid :wizard},
  :range 120},
 "1e3c8fad-55bd-4111-b6fd-1a062bd095a9"
 {:school :conjuration,
  :name "Tsunami",
  :concentration true,
  ...
  :components "VS",
  :ritual "no",
  :id "1e3c8fad-55bd-4111-b6fd-1a062bd095a9",
  :casting-time "1 minute",
  :classes #{:druid},
  :range :sight},
 "dc041036-fc4c-44ae-bf26-52442cb58c44"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "dc041036-fc4c-44ae-bf26-52442cb58c44",
  :casting-time "1 action",
  :classes #{:druid :ranger :sorcerer :wizard},
  :range :touch},
 "07d37c9d-963b-44b9-9f26-862a27e3ddb4"
 {:school :transmutation,
  :name "Erupting Earth",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VSM",
  :ritual "no",
  :id "07d37c9d-963b-44b9-9f26-862a27e3ddb4",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 120},
 "983f24c6-6868-46e3-872c-f10ee0e1f1f0"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "983f24c6-6868-46e3-872c-f10ee0e1f1f0",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range :touch},
 "9e993318-a967-443d-b162-632b2440440d"
 {:description
  ...
  :components "VSMgp",
  :ritual "yes",
  :id "9e993318-a967-443d-b162-632b2440440d",
  :srd-name "Instant Summons",
  :casting-time "1 minute",
  :classes #{:wizard},
  :range :touch},
 "b14f5097-03e5-4a77-a14a-94fcbed43b9f"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b14f5097-03e5-4a77-a14a-94fcbed43b9f",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range :self},
 "928e46a2-5458-4385-b926-78abb1d3e9c3"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "928e46a2-5458-4385-b926-78abb1d3e9c3",
  :casting-time "24 hours",
  :classes #{:cleric},
  :range :touch},
 "ecbe2827-1a61-4344-89d2-899f5fb79c10"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ecbe2827-1a61-4344-89d2-899f5fb79c10",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "2d2a2925-e8a3-435c-b1c8-80a5ebad019f"
 {:school :conjuration,
  :name "Hail of Thorns",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "V",
  :ritual "no",
  :id "2d2a2925-e8a3-435c-b1c8-80a5ebad019f",
  :casting-time "1 bonus action",
  :classes #{:ranger},
  :range :self},
 "2622790b-abea-44c6-a519-8229db019bc7"
 {:school :abjuration,
  ...
  :components "V",
  :ritual "no",
  :id "2622790b-abea-44c6-a519-8229db019bc7",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "c155424a-49ed-4e11-8a29-e7de672945cd"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "c155424a-49ed-4e11-8a29-e7de672945cd",
  :casting-time "1 action",
  :material-components "a small block of granite",
  :classes #{:druid :sorcerer :wizard},
  :range 120},
 "4721fa9f-0a94-45df-9e49-9f7cd5127035"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "4721fa9f-0a94-45df-9e49-9f7cd5127035",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :bard},
  :range 90},
 "845cea13-3ff1-4fb8-b2b4-e7032de76a42"
 {:description
  ...
  :components "VM",
  :ritual "no",
  :id "845cea13-3ff1-4fb8-b2b4-e7032de76a42",
  :casting-time "1 reaction",
  :classes #{:sorcerer :wizard :bard},
  :range 60},
 "9e4584c7-c81c-46b6-8d90-5efa57495e0d"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "9e4584c7-c81c-46b6-8d90-5efa57495e0d",
  :casting-time "1 minute",
  :classes #{:druid :warlock},
  :range 90},
 "3bc3f29b-2789-4e3c-9098-4b0722bb3e01"
 {:school :abjuration,
  :name "Blade Ward",
  :concentration false,
  :duration "1 round",
  ...
  :components "VS",
  :ritual "no",
  :id "3bc3f29b-2789-4e3c-9098-4b0722bb3e01",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range :self},
 "fccba79a-bf13-465c-bc26-463c0a7093dc"
 {:school :necromancy,
  :name "Feign Death",
  :concentration false,
  :duration "1 hour",
  ...
  :components "VSM",
  :ritual "yes",
  :id "fccba79a-bf13-465c-bc26-463c0a7093dc",
  :casting-time "1 action",
  :classes #{:cleric :druid :wizard :bard},
  :range :touch},
 "522306cd-0fad-41f6-a4e9-54b2edc2b1c9"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "522306cd-0fad-41f6-a4e9-54b2edc2b1c9",
  :casting-time "10 minutes",
  :classes #{:wizard :bard},
  :range :touch},
 "698be371-7b31-4f9c-92bc-45d9e431a053"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "698be371-7b31-4f9c-92bc-45d9e431a053",
  :srd-name "Private Sanctum",
  :casting-time "10 minutes",
  :classes #{:wizard},
  :range 120},
 "bf87ffab-d7f7-408c-bab1-f2cf261c8d6d"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "bf87ffab-d7f7-408c-bab1-f2cf261c8d6d",
  :casting-time "1 action",
  :material-components "a tiny strip of white cloth",
  :classes #{:cleric :paladin},
  :range 30},
 "e31c8fcb-e10a-4c88-a24a-d4e0123660e5"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "e31c8fcb-e10a-4c88-a24a-d4e0123660e5",
  :casting-time "1 action",
  :classes #{:cleric :druid},
  :range :touch},
 "a08a0155-12aa-4642-a20a-a8e88cf0dde8"
 {:school :transmutation,
  :name "Catapult",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "S",
  :ritual "no",
  :id "a08a0155-12aa-4642-a20a-a8e88cf0dde8",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 150},
 "33804ad0-cc9e-4558-aa74-e402efd3cd11"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "33804ad0-cc9e-4558-aa74-e402efd3cd11",
  :casting-time "10 minutes",
  :classes #{:cleric :wizard :bard},
  :range :self},
 "c7f8abfb-817e-4bed-a483-f244af30c91f"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "c7f8abfb-817e-4bed-a483-f244af30c91f",
  :casting-time "1 action",
  :material-components "a bit of bat fur",
  :classes #{:wizard},
  :range 30},
 "bbdf72bb-66b7-4456-aead-c12451250511"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "bbdf72bb-66b7-4456-aead-c12451250511",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 150},
 "b15f4445-357b-4eb8-99a4-be77f4fc7b1e"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b15f4445-357b-4eb8-99a4-be77f4fc7b1e",
  :casting-time "1 action",
  :classes #{:druid},
  :range 120},
 "8fb3db66-8f5f-4272-be4b-c9f44c21ad88"
 {:school :transmutation,
  :name "Swift Quiver",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "VSM",
  :ritual "no",
  :id "8fb3db66-8f5f-4272-be4b-c9f44c21ad88",
  :casting-time "1 bonus action",
  :classes #{:ranger},
  :range :touch},
 "33051c9e-b6b6-4a64-b859-b2381f514a4a"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "33051c9e-b6b6-4a64-b859-b2381f514a4a",
  :casting-time "1 action",
  :classes #{:cleric :sorcerer :wizard :warlock :paladin},
  :range 60},
 "bc825aa5-2504-42a5-acba-77820576bc66"
 {:school :transmutation,
  :name "Elemental Bane",
  :concentration true,
  :duration "Concentration, 1 minute",
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "3efd415e-2dbf-49a3-b1d7-46ad53f4e759",
  :casting-time "1 action",
  :classes #{:druid :sorcerer},
  :range 60},
 "6c6d3964-9047-4f4c-aeb5-a9bd8e94f909"
 {:school :evocation,
  :name "Maelstrom",
  :concentration true,
  :duration "Concentration, 1 minute",
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "2463647c-3338-439b-8440-2edfbd07f92f",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 60},
 "58f244dd-2893-4a19-bb72-0f61126f29cd"
 {:school :conjuration,
  ...
  :components "VSM",
  :ritual "no",
  :id "58f244dd-2893-4a19-bb72-0f61126f29cd",
  :casting-time "1 action",
  :classes #{:ranger},
  :range :self},
 "e371832c-ed71-4c35-8d02-0146cf9d2146"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "e371832c-ed71-4c35-8d02-0146cf9d2146",
  :casting-time "1 action",
  :classes #{:wizard :warlock :bard},
  :range 100},
 "b68c9679-4d42-4c96-bf1f-ed1d1ff37b5c"
 {:school :abjuration,
  ...
  :components "V",
  :ritual "no",
  :id "b68c9679-4d42-4c96-bf1f-ed1d1ff37b5c",
  :casting-time "1 action",
  :classes #{:paladin},
  :range :self},
 "c98d2b38-b50f-4fb4-925e-7ba60affec79"
 {:description
  ...
  :components "SM",
  :ritual "no",
  :id "c98d2b38-b50f-4fb4-925e-7ba60affec79",
  :casting-time "1 action",
  :material-components "a bit of fleece",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 30},
 "be8b1b15-0a0c-4093-ae3f-fc9112810b2e"
 {:school :evocation,
  :name "Whirlwind",
  :concentration true,
  :duration "Concentration, 1 minute",
  ...
  :components "VM",
  :ritual "no",
  :id "be8b1b15-0a0c-4093-ae3f-fc9112810b2e",
  :casting-time "1 action",
  :classes #{:druid :wizard},
  :range 300},
 "d476460b-2cb4-424d-861d-72ace13bf598"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "d476460b-2cb4-424d-861d-72ace13bf598",
  :casting-time "10 minutes",
  :classes #{:cleric :druid :wizard},
  :range :self},
 "61ca9e4a-942f-49f9-970d-bd444ac12749"
 {:description
 ...
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "2c2e0454-a702-4461-8a11-128ec17f24fc",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range 60},
 "c74b37d3-35ab-4cb5-9e36-9b678a810b91"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "c74b37d3-35ab-4cb5-9e36-9b678a810b91",
  :casting-time "1 action",
  :classes #{:warlock :bard},
  :range 60},
 "f8ba6bdb-0689-4aa1-ae9c-4e7584e4a5f4"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "f8ba6bdb-0689-4aa1-ae9c-4e7584e4a5f4",
  :casting-time "1 action",
  :classes #{:cleric :paladin},
  :range 30},
 "6abf01d2-1de6-48c4-b665-6c279ced0019"
 {:school :evocation,
  :name "Wrathful Smite",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "V",
  :ritual "no",
  :id "6abf01d2-1de6-48c4-b665-6c279ced0019",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "5fa60739-3fc2-4b8e-a76d-73d385cbb4ad"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "5fa60739-3fc2-4b8e-a76d-73d385cbb4ad",
  :casting-time "1 action",
  :material-components
  "an ointment for the eyes that costs 25 gp; is made from mushroom powder, saffron, and fat; and is consumed by the spell",
  :classes #{:cleric :sorcerer :wizard :warlock :bard},
  :range :touch},
 "3f4794c5-7646-44b4-a752-cd19627e0cfd"
 {:school :conjuration,
  ...
  :components "VSM",
  :ritual "no",
  :id "3f4794c5-7646-44b4-a752-cd19627e0cfd",
  :casting-time "1 action",
  :classes #{:warlock},
  :range 150},
 "8b408a37-600b-4e98-8337-b9692da3bb67"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "8b408a37-600b-4e98-8337-b9692da3bb67",
  :casting-time "1 action",
  :classes #{:bard},
  :range 30},
 "8675541c-8b14-4b74-ae08-8b0f091fc88a"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "8675541c-8b14-4b74-ae08-8b0f091fc88a",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 90},
 "58e8e395-ca48-40dd-b0dc-41de5ea43a19"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "58e8e395-ca48-40dd-b0dc-41de5ea43a19",
  :srd-name "Arcane Hand",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 120},
 "d83de14e-e066-4d74-b4df-326d8491a7cb"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "d83de14e-e066-4d74-b4df-326d8491a7cb",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "3123a595-cfb9-4027-a308-5785ca747b01"
 {:school :evocation,
  :name "Witch Bolt",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "VSM",
  :ritual "no",
  :id "3123a595-cfb9-4027-a308-5785ca747b01",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock},
  :range 30},
 "3132bbb7-fed5-4265-a90e-ac70adec41a7"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "3132bbb7-fed5-4265-a90e-ac70adec41a7",
  :casting-time "1 action",
  :classes #{:wizard :warlock},
  :range 60},
 "d0e50c7b-bc35-40a5-9374-caea5a7cd775"
 {:school :conjuration,
  :name "Create Bonfire",
  :concentration true,
  :duration "Concentration, 1 minute",
  ...
  :components "VS",
  :ritual "no",
  :id "d0e50c7b-bc35-40a5-9374-caea5a7cd775",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range 60},
 "169d2556-fe97-4332-92f2-b8e7557c3043"
 {:school :conjuration,
  :name "Arcane Gate",
  :concentration true,
  :duration "Concentration, up to 10 minutes",
  ...
  :components "VS",
  :ritual "no",
  :id "169d2556-fe97-4332-92f2-b8e7557c3043",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock},
  :range 500},
 "e54817a6-2719-4c27-9017-2e5646b4cc9e"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "e54817a6-2719-4c27-9017-2e5646b4cc9e",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :bard},
  :range 60},
 "e793bde1-adda-437f-9fe8-532ddbb624f7"
 {:description
 ...
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "64bfe495-b91f-4624-9ce5-4c68adfc27c4",
  :casting-time "1 hour",
  :classes #{:cleric :druid :wizard :bard},
  :range 60},
 "b3ab9370-fe78-475e-8750-27e6dddf1b35"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "b3ab9370-fe78-475e-8750-27e6dddf1b35",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 60},
 "cd7e772c-8cf4-4a75-8e02-adcfea3967f5"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "cd7e772c-8cf4-4a75-8e02-adcfea3967f5",
  :casting-time "1 action",
  :material-components "a pinch of sesame seeds",
  :classes #{:wizard},
  :range 30},
 "342d3f80-ccaa-44b4-9f69-b6df132db2d4"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "342d3f80-ccaa-44b4-9f69-b6df132db2d4",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock},
  :range 150},
 "e0ad9c3d-1db2-4592-88c7-445273e402d5"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "e0ad9c3d-1db2-4592-88c7-445273e402d5",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range :self},
 "84ebb0a2-7ce7-48fd-8bed-d918e730ad2f"
 {:school :evocation,
  :name "Wall of Water",
  :concentration true,
  :duration "Concentration, 10 minutes",
  ...
  :components "VSM",
  :ritual "no",
  :id "84ebb0a2-7ce7-48fd-8bed-d918e730ad2f",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 60},
 "d618bfb6-f53b-45de-9b14-d40fca7e913a"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "d618bfb6-f53b-45de-9b14-d40fca7e913a",
  :casting-time "1 action",
  :classes #{:wizard :bard},
  :range 120},
 "9e150615-f0cf-48aa-84c2-f938ed58dc34"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "9e150615-f0cf-48aa-84c2-f938ed58dc34",
  :casting-time "1 action",
  :classes #{:druid :ranger :bard},
  :range :self},
 "e90f8e2b-a931-4dad-9fc6-1dd04a64ecbb"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "e90f8e2b-a931-4dad-9fc6-1dd04a64ecbb",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "22626c4c-a013-4e04-9df7-7bd14dfb5cab"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "22626c4c-a013-4e04-9df7-7bd14dfb5cab",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "9683adc0-ea78-4b0f-a82a-244b434c63a3"
 {:description
  ...
  :components "VSMgp",
  :ritual "yes",
  :id "9683adc0-ea78-4b0f-a82a-244b434c63a3",
  :casting-time "1 minute",
  :material-components
  "specially marked sticks, bones, or similar tokens worth at least 25 gp",
  :classes #{:cleric},
  :range :self},
 "5d9a703a-9e1b-454a-80e0-492dfa8ab03d"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "5d9a703a-9e1b-454a-80e0-492dfa8ab03d",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range :self},
 "c43ad969-363a-45dc-85bc-8243ed2ede59"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "c43ad969-363a-45dc-85bc-8243ed2ede59",
  :casting-time "1 action",
  :material-components "pinch of sulfur",
  :classes #{:cleric},
  :range 60},
 "1cbad6da-24db-4184-875a-227b04f073cf"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "1cbad6da-24db-4184-875a-227b04f073cf",
  :casting-time "1 action",
  :classes #{:druid :bard},
  :range 60},
 "a1616dfd-a92b-4e14-9827-b376bf53669b"
 {:description
  ...
  :components "VSMgp",
  :ritual "yes",
  :id "a1616dfd-a92b-4e14-9827-b376bf53669b",
  :casting-time "10 minutes",
  :classes #{:cleric},
  :range :touch},
 "3778e122-eb50-4f9d-b764-f862fa36c210"
 {:description
 ...
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "3010b972-cecd-4879-868d-b7612a2d3065",
  :casting-time "1 minute",
  :classes #{:cleric :wizard :warlock},
  :range 10},
 "a48dacf6-4bd6-44c3-8be9-899c51409764"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "a48dacf6-4bd6-44c3-8be9-899c51409764",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 60},
 "ceb4cdd6-10db-4d29-9f72-95bfec96e63b"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "ceb4cdd6-10db-4d29-9f72-95bfec96e63b",
  :casting-time "1 action",
  :classes #{:druid :ranger :bard},
  :range :self},
 "c4108a04-7bd1-4134-b6dc-1b448a6b6a93"
 {:description
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "0b97667c-a020-4ede-91cb-4baabeedc645",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range :self},
 "b35fbb6d-5c76-4814-8096-3c3c93a427d0"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b35fbb6d-5c76-4814-8096-3c3c93a427d0",
  :casting-time "1 minute",
  :classes #{:cleric :druid :sorcerer :wizard :bard},
  :range :touch},
 "6e1d2f3d-ee3d-4517-9d91-900d2c03893f"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "6e1d2f3d-ee3d-4517-9d91-900d2c03893f",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :bard},
  :range :self},
 "9c5dd43e-8492-4050-9260-4a3dc122b6cc"
 {:sources
  #js [#js {:file "/home/drow/Sites/donjon/data/dnd_5e/core/spell/destructive_smite.txt"} #js {:file "/home/drow/Sites/donjon/data/dnd_5e/core/spell/destructive_wave.txt"}],
  :item "Destructive Wave",
  :id "9c5dd43e-8492-4050-9260-4a3dc122b6cc"},
 "a9e4175b-40fc-4010-80c0-390add77d3f5"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "a9e4175b-40fc-4010-80c0-390add77d3f5",
  :casting-time "1 action",
  :material-components "a wing feather from any bird",
  :classes #{:sorcerer :wizard :warlock},
  :range :touch},
 "158e9232-0396-4784-8ccc-fdb482bed46d"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "158e9232-0396-4784-8ccc-fdb482bed46d",
  :casting-time "1 action",
  :classes #{:cleric :druid :sorcerer},
  :range 300},
 "0390bf04-8db4-47d6-9668-d0cbd5155349"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "0390bf04-8db4-47d6-9668-d0cbd5155349",
  :casting-time "1 action",
  :classes #{:cleric :druid :sorcerer},
  :range 150},
 "601371bd-0c0b-4f49-9fcf-77ad0ae65fa1"
 {:school :transmutation,
  :name "Gust",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VS",
  :ritual "no",
  :id "601371bd-0c0b-4f49-9fcf-77ad0ae65fa1",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 30},
 "6e841e97-7e9e-46ab-9334-e5b7698b9630"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "6e841e97-7e9e-46ab-9334-e5b7698b9630",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 120},
 "ac1e518a-4cf6-4f88-8578-4a509e06c230"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ac1e518a-4cf6-4f88-8578-4a509e06c230",
  :casting-time "1 action",
  :classes #{:wizard},
  :range :self},
 "cea10361-8b47-43f7-8420-1ce82faaa9fc"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "cea10361-8b47-43f7-8420-1ce82faaa9fc",
  :casting-time "10 minutes",
  :classes #{:wizard},
  :range 120},
 "4c1f75e0-7c60-4499-bb2e-759ac3b59d1c"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "4c1f75e0-7c60-4499-bb2e-759ac3b59d1c",
  :srd-name "Irresistible Dance",
  :casting-time "1 action",
  :classes #{:wizard :bard},
  :range 30},
 "aa004339-08e6-4d93-92de-85748a27a6fe"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "aa004339-08e6-4d93-92de-85748a27a6fe",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range :self},
 "a79ca4a6-33ab-4d94-8148-83f550358f87"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "a79ca4a6-33ab-4d94-8148-83f550358f87",
  :casting-time "1 action",
  :classes #{:druid},
  :range :self},
 "59c860dd-2f2f-4c3d-8d59-cdef239c5d79"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "59c860dd-2f2f-4c3d-8d59-cdef239c5d79",
  :casting-time "1 action",
  :material-components
  "gold dust worth at least 25 gp, which the spell consumes",
  :classes #{:wizard},
  :range :touch},
 "1b885910-2421-4ded-b86e-fdd754e799a6"
 {:school :abjuration,
  ...
  :components "VSM",
  :ritual "no",
  :id "1b885910-2421-4ded-b86e-fdd754e799a6",
  :casting-time "1 action",
  :classes #{:warlock},
  :range :self},
 "6ade1553-7032-4d0d-98d9-f50de450258a"
 {:description
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "5120de46-6ae6-4bf1-b144-bf49ab4a8311",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 120},
 "a8aa06e4-70c3-4c53-9958-3555d6de31f9"
 {:school :transmutation,
  :name "Shape Water",
  :concentration false,
  :duration "1 hour",
  ...
  :components "S",
  :ritual "no",
  :id "a8aa06e4-70c3-4c53-9958-3555d6de31f9",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 30},
 "f47ff8bb-131d-42a0-8741-c92801903637"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "f47ff8bb-131d-42a0-8741-c92801903637",
  :casting-time "1 action",
  :classes #{:cleric :druid :sorcerer :bard},
  :range :touch},
 "835cbb7a-0a4d-47f6-82c2-dfeb5d808be4"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "835cbb7a-0a4d-47f6-82c2-dfeb5d808be4",
  :casting-time "1 action",
  :classes #{:druid},
  :range 120},
 "00c2b822-2a79-4622-b475-641ab56b1292"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "00c2b822-2a79-4622-b475-641ab56b1292",
  :casting-time "1 bonus action",
  :classes #{:cleric},
  :range 60},
 "1a1abf87-8ca0-48ee-9e09-0d6a52e3affd"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "1a1abf87-8ca0-48ee-9e09-0d6a52e3affd",
  :srd-name "Acid Arrow",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 90},
 "1f42f578-a877-4615-9317-4f9c53403b26"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "1f42f578-a877-4615-9317-4f9c53403b26",
  :casting-time "1 action",
  :classes #{:druid},
  :range :self},
 "57d99b4f-4dcb-4bda-9431-28bfc003efec"
 {:school :evocation,
  :name "Immolation",
  :concentration true,
  :duration "Concentration, 1 minute",
  ...
  :components "V",
  :ritual "no",
  :id "57d99b4f-4dcb-4bda-9431-28bfc003efec",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 90},
 "e11c5c4f-e3be-480d-be2a-b6db102c28fb"
 {:school :enchantment,
  :name "Compelled Duel",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "V",
  :ritual "no",
  :id "e11c5c4f-e3be-480d-be2a-b6db102c28fb",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range 30},
 "27033f30-08d2-43f6-982c-4ce8e7cc6d5e"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "27033f30-08d2-43f6-982c-4ce8e7cc6d5e",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 60},
 "e62af9ba-2f90-41b1-b9b7-dba4cf9be628"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "e62af9ba-2f90-41b1-b9b7-dba4cf9be628",
  :casting-time "1 minute",
  :classes #{:druid},
  :range 30},
 "23d032cc-ed24-4c39-9c67-34aecdf0eeeb"
 {:school :divination,
  :name "Beast Bond",
  :concentration true,
  :duration "Concentration, 10 minutes",
  ...
  :components "VSM",
  :ritual "no",
  :id "23d032cc-ed24-4c39-9c67-34aecdf0eeeb",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range :touch},
 "7a9c07d3-c5aa-46d1-9a38-b939f3e03c4d"
 {:school :evocation,
  :name "Wall of Sand",
  :concentration true,
  :duration "Concentration, 10 minutes",
  ...
  :components "VSM",
  :ritual "no",
  :id "7a9c07d3-c5aa-46d1-9a38-b939f3e03c4d",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 90},
 "f6194e15-1cbe-4951-945c-100a0eb18b43"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "f6194e15-1cbe-4951-945c-100a0eb18b43",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 30},
 "540d114d-9b8b-4e32-a2d0-0e05a90168e0"
 {:description
  ...
  :components "VS",
  :ritual "yes",
  :id "540d114d-9b8b-4e32-a2d0-0e05a90168e0",
  :casting-time "1 action",
  :classes #{:cleric :druid :paladin},
  :range 10},
 "9c393faf-ea5b-46c5-a4c8-ac5b3fdecd6f"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "9c393faf-ea5b-46c5-a4c8-ac5b3fdecd6f",
  :casting-time "1 action",
  :classes #{:wizard :bard},
  :range 500},
 "00c945ef-12ab-4f53-b5d3-cdc0ea1ed526"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "00c945ef-12ab-4f53-b5d3-cdc0ea1ed526",
  :casting-time "1 minute",
  :classes #{:sorcerer :wizard},
  :range 30},
 "b2f0d741-4b3b-4efe-802f-72c00ce86601"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b2f0d741-4b3b-4efe-802f-72c00ce86601",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range :self},
 "2fbe8320-fef8-4f28-a852-4ada7d91da0d"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "2fbe8320-fef8-4f28-a852-4ada7d91da0d",
  :casting-time "10 minutes",
  :classes #{:cleric},
  :range 30},
 "e733289b-95e1-4f9d-8e0a-d1ddc9753a94"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "e733289b-95e1-4f9d-8e0a-d1ddc9753a94",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "1263e5f3-26d8-4743-ae95-8139b91a3365"
 {:school :evocation,
  :name "Searing Smite",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "V",
  :ritual "no",
  :id "1263e5f3-26d8-4743-ae95-8139b91a3365",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "e97edaa5-eacf-49c4-91a3-1abc56a9ff2a"
 {:description
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "f4ea814c-337e-47ba-8254-f9cd04f7c3f8",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 120},
 "5aadf31a-c8f2-473d-b74d-860636af2a96"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "5aadf31a-c8f2-473d-b74d-860636af2a96",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 60},
 "9ac305c1-cfb8-405c-b091-7916dd3162d2"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "9ac305c1-cfb8-405c-b091-7916dd3162d2",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 120},
 "2e02b66d-7a61-4c44-9c45-ed42ede59255"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "2e02b66d-7a61-4c44-9c45-ed42ede59255",
  :casting-time "1 minute",
  :classes #{:druid :wizard},
  :range 90},
 "fe957cf5-8c78-44d3-9ddd-7f43513b0471"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "fe957cf5-8c78-44d3-9ddd-7f43513b0471",
  :srd-name "Telepathic Bond",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 30},
 "645f4f74-49bd-452b-aeb7-455ecd0096a0"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "645f4f74-49bd-452b-aeb7-455ecd0096a0",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range 120},
 "df882235-5554-4b53-a870-c954e3d31882"
 {:school :evocation,
  :name "Warding Wind",
  :concentration true,
  :duration "Concentration, 10 minutes",
 ...
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "6b130224-bf1f-4f4f-a4d4-7762bb329c77",
  :casting-time "1 action",
  :classes #{:druid :ranger :bard},
  :range 30},
 "06100c22-d8f1-4143-a8df-dd2cb09d80e2"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "06100c22-d8f1-4143-a8df-dd2cb09d80e2",
  ...
  :classes #{:wizard :bard},
  :range 60},
 "22db0a69-f5ab-4d56-8540-e3d82d3f1136"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "22db0a69-f5ab-4d56-8540-e3d82d3f1136",
  :casting-time "10 minutes",
  :classes #{:druid :wizard :warlock :bard},
  :range 300},
 "917f70a4-c627-4905-90dd-d5980994051f"
 {:school :conjuration,
  :name "Ice Knife",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "SM",
  :ritual "no",
  :id "917f70a4-c627-4905-90dd-d5980994051f",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 60},
 "54b4935c-d1f4-436f-b3a4-31262217f95c"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "54b4935c-d1f4-436f-b3a4-31262217f95c",
  :casting-time "1 bonus action",
  :classes #{:ranger},
  :range :self},
 "359a11bf-d661-4cee-a5ce-0c0ba2b9cce3"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "359a11bf-d661-4cee-a5ce-0c0ba2b9cce3",
  :casting-time "1 action",
  :classes #{:wizard :warlock},
  :range 60},
 "e2fe98af-ae3f-4a30-ba2b-7a225b849719"
 {:school :enchantment,
  ...
  :components "V",
  :ritual "no",
  :id "e2fe98af-ae3f-4a30-ba2b-7a225b849719",
  :casting-time "1 action",
  :classes #{:bard},
  :range 60},
 "f3497c88-27f7-4083-ab66-1105e53b68af"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "f3497c88-27f7-4083-ab66-1105e53b68af",
  :casting-time "1 action",
  :material-components "a chip of mica",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 60},
 "da89ce1b-addc-41c9-b57c-b0941155adc9"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "da89ce1b-addc-41c9-b57c-b0941155adc9",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 100},
 "88564610-d324-47e9-aa01-89732277fdcc"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "88564610-d324-47e9-aa01-89732277fdcc",
  :casting-time "1 bonus action",
  :classes #{:cleric},
  :range 60},
 "b2cca0f6-ecd3-433d-a865-71e48c4efa69"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b2cca0f6-ecd3-433d-a865-71e48c4efa69",
  :casting-time "1 action",
  :classes #{:cleric :druid :wizard},
  :range :touch},
 "7435db14-8b83-4ab3-93f2-1b3c1bb3927d"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "7435db14-8b83-4ab3-93f2-1b3c1bb3927d",
  :casting-time "1 action",
  :classes #{:druid},
  :range 120},
 "985d8c6f-5399-4870-a564-b1e0eb7d7eab"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "985d8c6f-5399-4870-a564-b1e0eb7d7eab",
  :casting-time "1 action",
  :material-components "an eyelash encased in gum arabic",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range :touch},
 "aac60905-70f1-4bba-93f5-43e8f9029539"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "aac60905-70f1-4bba-93f5-43e8f9029539",
  :casting-time "1 hour",
  :material-components
  "a diamond worth at least 1,000 gp, which the spell consumes",
  :classes #{:cleric :bard},
  :range :touch},
 "19b66da9-d27a-4ee0-a2db-f8906ec02d23"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "19b66da9-d27a-4ee0-a2db-f8906ec02d23",
  :casting-time "10 minutes",
  :classes #{:cleric :druid :wizard :warlock :bard},
  :range :self},
 "43fb0588-30d5-4d17-8198-f61600b951a5"
 {:school :abjuration,
  ...
  :components "S",
  :ritual "no",
  :id "43fb0588-30d5-4d17-8198-f61600b951a5",
  :casting-time "1 reaction",
  :classes #{:druid :ranger :wizard},
  :range :self},
 "0d4da5b9-8ed1-4931-b1d2-668bef927ef9"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "0d4da5b9-8ed1-4931-b1d2-668bef927ef9",
  :casting-time "1 action",
  :classes #{:cleric},
  :range :touch},
 "ec31e97a-6350-44a4-809a-6b0279e53370"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "ec31e97a-6350-44a4-809a-6b0279e53370",
  :casting-time "1 action",
  :classes #{:druid},
  :range 120},
 "1493dc93-15c2-48f7-afa6-e6b630f3e3c0"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "1493dc93-15c2-48f7-afa6-e6b630f3e3c0",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 30},
 "0e6cbf8b-b28f-4891-96d0-61018f3f2583"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "0e6cbf8b-b28f-4891-96d0-61018f3f2583",
  :srd-name "Freezing Sphere",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 300},
 "e5c2f132-363f-45ad-a825-ecd3744ace30"
 {:description
  ...
  :components "S",
  :ritual "no",
  :id "e5c2f132-363f-45ad-a825-ecd3744ace30",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 30},
 "0e457107-b93b-4ded-86a2-8552d0577b82"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "0e457107-b93b-4ded-86a2-8552d0577b82",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 120},
 "c95eeadb-b244-49a0-9997-4957d4bb607a"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "c95eeadb-b244-49a0-9997-4957d4bb607a",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "5ec8929e-b939-4981-950e-193409071bfc"
 {:description
  ...
  :components "SMgp",
  :ritual "yes",
  :id "5ec8929e-b939-4981-950e-193409071bfc",
  :casting-time "1 minute",
  :classes #{:wizard :warlock :bard},
  :range :touch},
 "80a0500f-dc3f-47dd-b2d9-a58fb7763aaf"
 {:school :divination,
  :name "Beast Sense",
  :concentration true,
  :duration "Concentration, up to 1 hour",
  ...
  :components "S",
  :ritual "yes",
  :id "80a0500f-dc3f-47dd-b2d9-a58fb7763aaf",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range :touch},
 "6e08421a-c787-42c0-9520-2348395eef6b"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "6e08421a-c787-42c0-9520-2348395eef6b",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock},
  :range 60},
 "7d1ffbcb-6dcb-4c84-a1b7-7b8389d92fd1"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "7d1ffbcb-6dcb-4c84-a1b7-7b8389d92fd1",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger :sorcerer :wizard},
  :range :touch},
 "4fc48228-09c8-4484-81d3-e2dbe7d0e0d7"
 {:description
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "524061f4-220c-4a83-b80c-c9994fb74a6b",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "27324466-2e07-4397-8c0b-98d1d8a7364b"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "27324466-2e07-4397-8c0b-98d1d8a7364b",
  :casting-time "1 bonus action",
  :classes #{:druid},
  :range :self},
 "91cfd9e0-a9e4-4321-b864-b17af5e71cf6"
 {:school :conjuration,
  :name "Arms of Hadar",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VS",
  :ritual "no",
  :id "91cfd9e0-a9e4-4321-b864-b17af5e71cf6",
  :casting-time "1 action",
  :classes #{:warlock},
  :range :self},
 "b7c6866f-acca-4de8-8d19-9d7d0c5e710f"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "b7c6866f-acca-4de8-8d19-9d7d0c5e710f",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range 30},
 "0edccbbf-559c-4f9c-a28e-d40540601335"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "0edccbbf-559c-4f9c-a28e-d40540601335",
  :casting-time "1 bonus action",
  :classes #{:cleric :druid :bard},
  :range 60},
 "8a63ea2b-05f1-46ca-8ce4-23e459d772a7"
 {:school :necromancy,
  ...
  :components "VSM",
  :ritual "no",
  :id "8a63ea2b-05f1-46ca-8ce4-23e459d772a7",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 150},
 "df783fb4-1c14-4825-a3e4-b97232f35863"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "df783fb4-1c14-4825-a3e4-b97232f35863",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 10},
 "39ccf1bc-aa4d-4086-92d4-128283669067"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "39ccf1bc-aa4d-4086-92d4-128283669067",
  :casting-time "1 action",
  :material-components "a shaving of licorice root",
  :classes #{:sorcerer :wizard},
  :range 30},
 "28ee1de8-244a-40dd-8c7a-b87f974581c0"
 {:school :transmutation,
  :name "Mold Earth",
  :concentration false,
  :duration "1 hour",
  ...
  :components "S",
  :ritual "no",
  :id "28ee1de8-244a-40dd-8c7a-b87f974581c0",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 30},
 "644947ef-693f-48e0-a332-329d7f0bd09b"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "644947ef-693f-48e0-a332-329d7f0bd09b",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "550fc791-4bb1-4749-9447-fc219f938508"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "550fc791-4bb1-4749-9447-fc219f938508",
  :casting-time "1 action",
  :classes #{:druid},
  :range :sight},
 "2b6ba7ed-957e-45e8-995f-8322a633e3af"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "2b6ba7ed-957e-45e8-995f-8322a633e3af",
  :srd-name "Black Tentacles",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 90},
 "d07bb5be-6c48-4b14-9eba-27e6ccd66f09"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "d07bb5be-6c48-4b14-9eba-27e6ccd66f09",
  :casting-time "1 bonus action",
  :classes #{:sorcerer :wizard :warlock},
  :range :self},
 "4322c7cd-b3bb-470e-b0ec-f4c49efa8503"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "4322c7cd-b3bb-470e-b0ec-f4c49efa8503",
  :casting-time "10 minutes",
  :material-components
  "a gem-encrusted bowl worth at least 1,000 gp, which the spell consumes",
  :classes #{:cleric :druid},
  :range 30},
 "61192d4e-afeb-41a3-b965-29c16254d06a"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "61192d4e-afeb-41a3-b965-29c16254d06a",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "ca48dc5c-83ae-43dc-839e-8646d8b2c06b"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "ca48dc5c-83ae-43dc-839e-8646d8b2c06b",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range 10},
 "79b40e5c-a3da-4d54-9adb-2afeb007517e"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "79b40e5c-a3da-4d54-9adb-2afeb007517e",
  :srd-name "Magnificent Mansion",
  :casting-time "1 minute",
  :classes #{:wizard :bard},
  :range 300},
 "30b43300-fbdc-45a7-865a-af2d51a3b576"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "30b43300-fbdc-45a7-865a-af2d51a3b576",
  :casting-time "10 minutes",
  :classes #{:druid :wizard :bard},
  :range :sight},
 "457c5e64-ea28-482a-aefe-19cfddc19af9"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "457c5e64-ea28-482a-aefe-19cfddc19af9",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 60},
 "530d6bcb-5cbd-4984-84c7-11857a6fe100"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "530d6bcb-5cbd-4984-84c7-11857a6fe100",
  :casting-time "1 action",
  :material-components
  "a bit of phosphorus or wychwood, or a glowworm",
  :classes #{:sorcerer :wizard :bard},
  :range 120},
 "abdf7319-3fe6-4b40-a63a-11dce34e24cf"
 {:school :enchantment,
  :name "Friends",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "SM",
  :ritual "no",
  :id "abdf7319-3fe6-4b40-a63a-11dce34e24cf",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range :self},
 "86ba559e-03b5-46f2-b783-d7cb503e05ad"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "86ba559e-03b5-46f2-b783-d7cb503e05ad",
  :casting-time "1 minute",
  :classes #{:cleric :wizard :bard},
  :range :touch},
 "b77abd25-67a3-4080-a31e-225aa4107dcc"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "b77abd25-67a3-4080-a31e-225aa4107dcc",
  :casting-time "1 minute",
  :material-components "a tiny bell and a piece of fine silver wire",
  :classes #{:ranger :wizard},
  :range 30},
 "af48c63d-9c31-46d8-828f-6629f2f47312"
 {:school :transmutation,
  :name "Control Flames",
  :concentration false,
  :duration "1 hour",
  ...
  :components "S",
  :ritual "no",
  :id "af48c63d-9c31-46d8-828f-6629f2f47312",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 60},
 "d7d7478f-3000-4846-a293-02df4474fa39"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "d7d7478f-3000-4846-a293-02df4474fa39",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range :self},
 "b2016e64-559f-4b51-8e02-a2f78073b467"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b2016e64-559f-4b51-8e02-a2f78073b467",
  :srd-name "Arcanist's Magic Aura",
  :casting-time "1 action",
  :classes #{:wizard},
  :range :touch},
 "e06927d5-6e65-466c-a0d9-c3d3816d9c2b"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "e06927d5-6e65-466c-a0d9-c3d3816d9c2b",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 500},
 "17557f9e-bf6c-4b7e-bb81-52ed8cca8a16"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "17557f9e-bf6c-4b7e-bb81-52ed8cca8a16",
  :casting-time "1 action",
  :classes #{:druid :ranger :sorcerer :wizard},
  :range 30},
 "5e861122-2b4b-4ef5-ab77-35ca6e832c67"
 {:description
  ...
  :components "VS",
  :ritual "yes",
  :id "5e861122-2b4b-4ef5-ab77-35ca6e832c67",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger :sorcerer :wizard :paladin :bard},
  :range :self},
 "aac57310-e373-4283-9c6a-f88f436f9962"
 {:description
  ...
  :components "VSMgp",
  :ritual "yes",
  :id "aac57310-e373-4283-9c6a-f88f436f9962",
  :casting-time "1 minute",
  :classes #{:wizard :bard},
  :range 30},
 "4da38009-2d2f-4d60-affc-92c743050040"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "4da38009-2d2f-4d60-affc-92c743050040",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 30},
 "2afa6b15-53df-4878-838f-ad610ec01ad5"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "2afa6b15-53df-4878-838f-ad610ec01ad5",
  :casting-time "1 action",
  :classes #{:cleric :wizard :warlock :paladin},
  :range :touch},
 "b3fed962-2049-4d40-9508-60ae49f19523"
 {:school :transmutation,
  :name "Skywrite",
  :concentration true,
  :duration "Concentration, 1 hour",
  ...
  :components "VS",
  :ritual "yes",
  :id "b3fed962-2049-4d40-9508-60ae49f19523",
  :casting-time "1 action",
  :classes #{:druid :wizard :bard},
  :range :sight},
 "02691bb7-d18c-4d1c-817a-6c7b4e7a55b4"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "02691bb7-d18c-4d1c-817a-6c7b4e7a55b4",
  :casting-time "1 action",
  :classes #{:cleric :wizard},
  :range :touch},
 "38e99548-cb8e-44dd-b3c9-b90c86f17317"
 {:school :evocation,
  :name "Earth Tremor",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VS",
  :ritual "no",
  :id "38e99548-cb8e-44dd-b3c9-b90c86f17317",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :bard},
  :range :self},
 "006671f5-d116-45eb-9115-d44709c60971"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "006671f5-d116-45eb-9115-d44709c60971",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :touch},
 "8203d3e4-870e-4a27-b895-c58056e0c156"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "8203d3e4-870e-4a27-b895-c58056e0c156",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range :self},
 "8cca0de5-e585-4c97-98b7-b643444c39b0"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "8cca0de5-e585-4c97-98b7-b643444c39b0",
  :casting-time "1 action",
  :classes #{:druid :bard},
  :range 60},
 "81925932-e62f-46a0-81b0-adc5fcc2a8e8"
 {:school :enchantment,
  :name "Hex",
  :concentration true,
  ...
  :components "VSM",
  :ritual "no",
  :id "81925932-e62f-46a0-81b0-adc5fcc2a8e8",
  :casting-time "1 bonus action",
  :classes #{:warlock},
  :range 90},
 "1615654a-10e8-4bbe-a387-aa985672204c"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "1615654a-10e8-4bbe-a387-aa985672204c",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range :self},
 "6b29b8fa-baeb-498e-a009-2bc3b238ee53"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "6b29b8fa-baeb-498e-a009-2bc3b238ee53",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 30},
 "24d15b35-2a67-45a1-9f52-a71a4b3d14c5"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "24d15b35-2a67-45a1-9f52-a71a4b3d14c5",
  :casting-time "1 action",
  :material-components "a bit of fur from a bloodhound",
  :classes #{:cleric :druid :ranger :wizard :paladin :bard},
  :range :self},
 "1ee487ed-b9b3-4d17-bd3a-0b0cade4682c"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "1ee487ed-b9b3-4d17-bd3a-0b0cade4682c",
  :casting-time "1 action",
  :classes #{:druid},
  :range 30},
 "9a7f0f69-faa2-4231-a4f5-03920f1abc81"
 {:school :evocation,
  ...
  :components "V",
  :ritual "no",
  :id "9a7f0f69-faa2-4231-a4f5-03920f1abc81",
  :casting-time "1 bonus action",
  :classes #{:paladin},
  :range :self},
 "416634db-483b-449d-951f-a5d4ce244451"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "416634db-483b-449d-951f-a5d4ce244451",
  :casting-time "1 action",
  :material-components "a sprinkling of holy water",
  :classes #{:cleric :paladin},
  :range 30},
 "80cf74fc-68fb-4b94-8968-ce28e9e5a331"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "80cf74fc-68fb-4b94-8968-ce28e9e5a331",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock},
  :range :touch},
 "ca90e689-3fec-49a4-8b04-71315eaf3e2e"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "ca90e689-3fec-49a4-8b04-71315eaf3e2e",
  :casting-time "1 action",
  :classes #{:wizard :bard},
  :range 30},
 "6f529b48-5eb4-4dd0-8aa1-b86eebfde35a"
 {:school :conjuration,
  :name "Dust Devil",
  :concentration true,
  :duration "Concentration, 1 minute",
  ...
  :components "VSM",
  :ritual "no",
  :id "6f529b48-5eb4-4dd0-8aa1-b86eebfde35a",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 60},
 "b69b2695-9896-47a6-bbae-41f5a8f51b28"
 {:school :conjuration,
  ...
  :components "VSM",
  :ritual "no",
  :id "b69b2695-9896-47a6-bbae-41f5a8f51b28",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 60},
 "ba37f77b-5c17-49c9-8e44-6de63402ce7d"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ba37f77b-5c17-49c9-8e44-6de63402ce7d",
  :casting-time "1 bonus action",
  :material-components
  "a small parchment with a bit of holy text written on it",
  :classes #{:cleric :paladin},
  :range 60},
 "13403910-f8bb-4ef7-8eaa-4b573a2c4edb"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "13403910-f8bb-4ef7-8eaa-4b573a2c4edb",
  :casting-time "1 action",
  :classes #{:wizard :warlock :bard},
  :range 30},
 "01b6a64f-7beb-4b1e-bb92-052a6fa405c4"
 {:school :evocation,
  ...
  :components "VSM",
  :ritual "no",
  :id "01b6a64f-7beb-4b1e-bb92-052a6fa405c4",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "1da5808a-7f8f-45b8-ab84-257ddd966304"
 {:description
  ...
  :components "SM",
  :ritual "no",
  :id "1da5808a-7f8f-45b8-ab84-257ddd966304",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 120},
 "272e7862-ad99-493f-92f4-af12a824d144"
 {:school :evocation,
  ...
  :components "V",
  :ritual "no",
  :id "272e7862-ad99-493f-92f4-af12a824d144",
  :casting-time "1 action",
  :classes #{:paladin},
  :range :self},
 "e84ab89c-f5e6-4b8c-b443-ce4d1a96b905"
 {:school :evocation,
  :name "Chromatic Orb",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VSMgp",
  :ritual "no",
  :id "e84ab89c-f5e6-4b8c-b443-ce4d1a96b905",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 90},
 "68e81f69-7830-4553-aac3-c07ad651f9db"
 {:description
  ...
  :components "VS",
  :ritual "yes",
  :id "68e81f69-7830-4553-aac3-c07ad651f9db",
  :casting-time "1 action",
  :classes #{:cleric :ranger :bard},
  :range 120},
 "d2e42308-3db9-4c5e-a57b-41b6860ca531"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "d2e42308-3db9-4c5e-a57b-41b6860ca531",
  :casting-time "1 action",
  :material-components "a lodestone and a pinch of dust",
  :classes #{:sorcerer :wizard},
  :range 60},
 "c4cd3a30-6589-4d02-92c9-40c49bea5a34"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "c4cd3a30-6589-4d02-92c9-40c49bea5a34",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 120},
 "45641528-9a6a-42d5-8975-28ee93a6efd5"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "45641528-9a6a-42d5-8975-28ee93a6efd5",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 90},
 "cc7b9b0b-9061-4305-bd1c-50dc95f89e97"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "cc7b9b0b-9061-4305-bd1c-50dc95f89e97",
  :casting-time "1 action",
  :material-components "a tiny ball of bat guano and sulfur",
  :classes #{:sorcerer :wizard},
  :range 150},
 "823f690f-0f94-4b7e-9975-5279ad7d300e"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "823f690f-0f94-4b7e-9975-5279ad7d300e",
  :casting-time "1 action",
  :material-components
  "diamond dust worth 100 gp, which the spell consumes",
  :classes #{:druid :ranger :sorcerer :wizard},
  :range :touch},
 "ec4b7ec9-e446-4954-8332-20cd579ead5b"
 {:description
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "c176f03a-b372-487b-a72f-0d143ea67474",
  :casting-time "1 minute",
  :classes #{:cleric},
  :range 90},
 "0d166f06-5cde-492f-945e-7cdf111af1b8"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "0d166f06-5cde-492f-945e-7cdf111af1b8",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 30},
 "99e9e575-73ca-4ee9-8365-40d7b36ac832"
 {:school :abjuration,
  :name "Aura of Life",
  :concentration true,
  :duration "Concentration, up to 10 minutes",
  ...
  :components "V",
  :ritual "no",
  :id "99e9e575-73ca-4ee9-8365-40d7b36ac832",
  :casting-time "1 action",
  :classes #{:paladin},
  :range :self},
 "60d03ee1-6740-4817-92d3-570c093a344b"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "60d03ee1-6740-4817-92d3-570c093a344b",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 120},
 "3da2abcf-c888-4237-ac68-13e241b8c2ec"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "3da2abcf-c888-4237-ac68-13e241b8c2ec",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 30},
 "16b2979c-a02b-4d70-b8b8-2480953ee94a"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "16b2979c-a02b-4d70-b8b8-2480953ee94a",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range :self},
 "e37f4448-3e4d-488f-b512-3ae339687ba2"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "e37f4448-3e4d-488f-b512-3ae339687ba2",
  :casting-time "1 action",
  :material-components "fire and a piece of sunstone",
  :classes #{:druid :sorcerer :wizard},
  :range 150},
 "c22a279b-639b-41eb-915a-f4aa03da18fb"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "c22a279b-639b-41eb-915a-f4aa03da18fb",
  :srd-name "Hideous Laughter",
  :casting-time "1 action",
  :classes #{:wizard :bard},
  :range 30},
 "29b237b9-7a80-46e5-a4c3-bdd13a34f191"
 {:school :illusion,
  ...
  :components "VSM",
  :ritual "no",
  :id "29b237b9-7a80-46e5-a4c3-bdd13a34f191",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 60},
 "38a4dcb4-7e9b-473c-91d5-1b58bb6f6d6e"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "38a4dcb4-7e9b-473c-91d5-1b58bb6f6d6e",
  :casting-time "1 action",
  :material-components "a miniature cloak",
  :classes #{:cleric :druid},
  :range :touch},
 "11477233-b31a-4529-9bc3-86aca9f19f3b"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "11477233-b31a-4529-9bc3-86aca9f19f3b",
  :casting-time "1 action",
  :classes #{:druid :ranger :sorcerer :wizard},
  :range :touch},
 "4c882958-7bb2-4be8-b3c4-54ebd58fe468"
 {:school :evocation,
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "a82941bb-bf93-48ff-a54e-1bdc6edc26dd",
  :casting-time "1 action",
  :classes #{:cleric :wizard :bard},
  :range :touch},
 "8f64afb2-bf28-4b7e-a3ea-f831e0e71941"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "8f64afb2-bf28-4b7e-a3ea-f831e0e71941",
  :casting-time "1 hour",
  :classes #{:wizard},
  :range :touch},
 "273c1447-0e24-424b-9586-ffcb95e35e2e"
 {:description
 ...
 {:school :evocation,
  ...
  :components "VSM",
  :ritual "no",
  :id "6f880db5-4cb0-467e-9180-aa27e0cae485",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 90},
 "4e1be273-8995-46fb-b3a4-aaa0c212ab34"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "4e1be273-8995-46fb-b3a4-aaa0c212ab34",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock :bard},
  :range 30},
 "cf3a761a-21bc-490d-96d4-a6b47d28198e"
 {:description
  ...
  :components "VS",
  :ritual "yes",
  :id "cf3a761a-21bc-490d-96d4-a6b47d28198e",
  :casting-time "1 minute",
  :classes #{:wizard},
  :range 30},
 "0d81e16b-5988-4034-884b-c4e4ffd98f94"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "0d81e16b-5988-4034-884b-c4e4ffd98f94",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 120},
 "80b38a21-e60c-44bf-9334-6cdf50dddcae"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "80b38a21-e60c-44bf-9334-6cdf50dddcae",
  :casting-time "1 action",
  :material-components
  "a bit of tallow, a pinch of brimstone, and a dusting of powdered iron",
  :classes #{:druid :wizard},
  :range 60},
 "22a6eb18-c00e-43a8-bb31-00646cd85635"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "22a6eb18-c00e-43a8-bb31-00646cd85635",
  :casting-time "1 action",
  :classes #{:druid :ranger :wizard :bard},
  :range :touch},
 "af2f7adc-79f6-48f5-8e05-bbc25813f1c2"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "af2f7adc-79f6-48f5-8e05-bbc25813f1c2",
  :casting-time "1 action",
  :material-components "burning incense",
  :classes #{:cleric :bard},
  :range 10},
 "7ecd30f1-83be-43ef-a590-9b00d57d547f"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "7ecd30f1-83be-43ef-a590-9b00d57d547f",
  :srd-name "Faithful Hound",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 30},
 "23781bc2-d29c-4d49-a0f0-51de2ba8cde9"
 {:description
  ...
  :components "VS",
  :ritual "yes",
  :id "23781bc2-d29c-4d49-a0f0-51de2ba8cde9",
  :casting-time "1 minute",
  :classes #{:druid :ranger},
  :range :self},
 "1cb85fee-c631-46f6-9414-2542fb27c732"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "1cb85fee-c631-46f6-9414-2542fb27c732",
  :casting-time "1 action",
  :classes #{:cleric :bard},
  :range 30},
 "228cec47-b545-4838-a369-999102aaab66"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "228cec47-b545-4838-a369-999102aaab66",
  :casting-time "1 action",
  :classes #{:cleric :paladin},
  :range :self},
 "fc0960b1-b44e-4af2-8094-961df4a8b79f"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "fc0960b1-b44e-4af2-8094-961df4a8b79f",
  :casting-time "1 hour",
  :classes #{:cleric :wizard :bard},
  :range :touch},
 "95afc062-4bbd-4db5-924d-b880ab1a67c7"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "95afc062-4bbd-4db5-924d-b880ab1a67c7",
  :casting-time "1 action",
  :classes #{:cleric :paladin},
  :range :self},
 "27377006-4a7b-4099-8969-bf4c337ea620"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "27377006-4a7b-4099-8969-bf4c337ea620",
  :casting-time "1 action",
  :classes #{:cleric :paladin},
  :range :touch},
 "a28f38bf-9ccd-44d7-b489-cd071814ea9b"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "a28f38bf-9ccd-44d7-b489-cd071814ea9b",
  :casting-time "1 bonus action",
  :classes #{:ranger},
  :range 90},
 "420411f2-7df2-4a49-89f5-234b1e92dd19"
 {:description
  ...
  :components "S",
  :ritual "no",
  :id "420411f2-7df2-4a49-89f5-234b1e92dd19",
  :casting-time "1 reaction",
  :classes #{:sorcerer :wizard :warlock},
  :range 60},
 "1d2b400f-f53b-45d3-8c5c-127b374972b0"
 {:school :evocation,
  :name "Thunderclap",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "S",
  :ritual "no",
  :id "1d2b400f-f53b-45d3-8c5c-127b374972b0",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock :bard},
  :range :self},
 "6f1e64fb-e5d7-4ed4-ba01-68b9fc6107b3"
 {:description
  ...
  :components "VM",
  :ritual "no",
  :id "6f1e64fb-e5d7-4ed4-ba01-68b9fc6107b3",
  :casting-time "1 action",
  :material-components
  "a snake's tongue and either a bit of honeycomb or a drop of sweet oil",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 30},
 "5471e777-dee2-4e8e-8498-1816ad9144f6"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "5471e777-dee2-4e8e-8498-1816ad9144f6",
  :casting-time "1 action",
  :material-components "a pinch of soot and salt",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range :self},
 "6423857a-4a06-4840-beed-b6a7e8b0cdaa"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "6423857a-4a06-4840-beed-b6a7e8b0cdaa",
  :casting-time "1 bonus action",
  :classes #{:druid},
  :range :touch},
 "685fe200-9067-4cd5-a9d2-f161358fb32a"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "685fe200-9067-4cd5-a9d2-f161358fb32a",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 150},
 "6e65948e-6324-407d-a11f-422542d9acd9"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "6e65948e-6324-407d-a11f-422542d9acd9",
  :casting-time "1 action",
  :material-components "a small piece of phosphorus",
  :classes #{:druid :sorcerer :wizard},
  :range 120},
 "cefd857b-a21c-4628-8cb3-5f0643cd8f8a"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "cefd857b-a21c-4628-8cb3-5f0643cd8f8a",
  :casting-time "1 minute",
  :classes #{:druid :wizard},
  :range 90},
 "cf26133d-44cb-44b8-9a29-a5cce0b20aa2"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "cf26133d-44cb-44b8-9a29-a5cce0b20aa2",
  :casting-time "1 minute",
  :material-components "incense and a vial of holy or unholy water",
  :classes #{:cleric},
  :range :self},
 "ed38d3bc-7361-4be4-92e7-0f092d5905b3"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ed38d3bc-7361-4be4-92e7-0f092d5905b3",
  :casting-time "1 action",
  :material-components "a pinch of powdered iron or iron filings",
  :classes #{:cleric :wizard},
  :range :self},
 "5d485aa1-4ed0-4adc-ac08-0beddfd2a646"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "5d485aa1-4ed0-4adc-ac08-0beddfd2a646",
  :casting-time "1 hour",
  :material-components
  "rare oils and unguents worth at least 1,000 gp, which the spell consumes",
  :classes #{:druid},
  :range :touch},
 "10905544-4d2c-4379-b7a9-a285d7520369"
 {:school :conjuration,
  :name "Conjure Volley",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VSM",
  :ritual "no",
  :id "10905544-4d2c-4379-b7a9-a285d7520369",
  :casting-time "1 action",
  :classes #{:ranger},
  :range 150},
 "22be2b0e-73d2-4e8f-b81a-a815c044f71e"
 {:description
  ...
  :components "VS",
  :ritual "yes",
  :id "22be2b0e-73d2-4e8f-b81a-a815c044f71e",
  :casting-time "1 action",
  :classes #{:druid :ranger :bard},
  :range :self},
 "a2d2ee30-0439-48b3-a656-2f37f701f8f5"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "a2d2ee30-0439-48b3-a656-2f37f701f8f5",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock},
  :range :self},
 "d21d32c7-ab29-45cd-a621-e6f39f0536c3"
 {:school :evocation,
  :name "Storm Sphere",
  :concentration true,
  :duration "Concentration, 1 minute",
  ...
  :components "VS",
  :ritual "no",
  :id "d21d32c7-ab29-45cd-a621-e6f39f0536c3",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 150},
 "919bf4fa-4f50-462d-a8e4-146c2659058e"
 {:description
 ...
 {:school :conjuration,
  ...
  :components "VSM",
  :ritual "no",
  :id "adf02bf2-a19b-4692-9169-2952ecff53a5",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard},
  :range 90},
 "86ae59ce-7467-4722-831f-fa1b7340cbff"
 {:school :transmutation,
  ...
  :components "VSM",
  :ritual "no",
  :id "86ae59ce-7467-4722-831f-fa1b7340cbff",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 30},
 "dd16b02e-2114-453d-ac06-07635947174a"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "dd16b02e-2114-453d-ac06-07635947174a",
  :casting-time "1 action",
  :classes #{:cleric :druid},
  :range 60},
 "b09036ab-7056-4f1b-8d23-aef10980ac54"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b09036ab-7056-4f1b-8d23-aef10980ac54",
  :casting-time "1 action",
  :material-components "a small crystal or glass cone",
  :classes #{:sorcerer :wizard},
  :range :self},
 "097e7e96-f7b3-4c44-a4d7-f96faed68b23"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "097e7e96-f7b3-4c44-a4d7-f96faed68b23",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 60},
 "bb448eb5-852a-4ee0-b83c-a00f2691d8f0"
 {:description
  ...
  :components "S",
  :ritual "no",
  :id "bb448eb5-852a-4ee0-b83c-a00f2691d8f0",
  :casting-time "1 action",
  :classes #{:wizard :warlock},
  :range 60},
 "5628f53f-9798-46b4-9109-54f156bd6914"
 {:school :transmutation,
  :name "Transmute Rock",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VSM",
  :ritual "no",
  :id "5628f53f-9798-46b4-9109-54f156bd6914",
  :casting-time "1 action",
  :classes #{:druid :wizard},
  :range 120},
 "0fe624ec-49b4-48e3-bab1-40a848bfb947"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "0fe624ec-49b4-48e3-bab1-40a848bfb947",
  :casting-time "1 action",
  :material-components "a bit of spiderweb",
  :classes #{:sorcerer :wizard},
  :range 60},
 "c93762a4-130d-44c8-894e-9bcaa85899e9"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "c93762a4-130d-44c8-894e-9bcaa85899e9",
  :casting-time "1 action",
  :material-components
  "a pinch of dirt, a piece of rock, and a lump of clay",
  :classes #{:cleric :druid :sorcerer},
  :range 500},
 "af19690f-21b1-4a09-ba56-87c860111694"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "af19690f-21b1-4a09-ba56-87c860111694",
  :casting-time "1 minute",
  :classes #{:wizard},
  :range :self},
 "780df3c5-bbe2-45a0-a117-9a6161b454bc"
 {:school :conjuration,
  :name "Grasping Vine",
  :concentration true,
  :duration "Concentration, up to 1 minute",
  ...
  :components "VS",
  :ritual "no",
  :id "780df3c5-bbe2-45a0-a117-9a6161b454bc",
  :casting-time "1 bonus action",
  :classes #{:druid :ranger},
  :range 30},
 "a3d2dacd-7d98-4d26-b088-50bad4646cf5"
 {:description
  ...
  :components "VSMgp",
  :ritual "yes",
  :id "a3d2dacd-7d98-4d26-b088-50bad4646cf5",
  :casting-time "1 hour",
  :classes #{:wizard},
  :range 10},
 "126a7749-10f8-4e5f-bbb1-d849656f7106"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "126a7749-10f8-4e5f-bbb1-d849656f7106",
  :casting-time "1 action",
  :material-components "a small, straight piece of iron",
  :classes #{:cleric :druid :sorcerer :wizard :warlock :bard},
  :range 60},
 "4a58f6c6-2a08-4f1e-b1a7-15a356192de8"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "4a58f6c6-2a08-4f1e-b1a7-15a356192de8",
  :casting-time "1 action",
  :material-components
  "diamonds worth 300 gp, which the spell consumes",
  :classes #{:cleric :paladin},
  :range :touch},
 "552d1da1-0279-4de2-8a02-53105778648c"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "552d1da1-0279-4de2-8a02-53105778648c",
  :casting-time "1 action",
  :classes #{:paladin},
  :range :touch},
 "ab0820e1-d6a5-4658-b296-18ca2606aaf8"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "ab0820e1-d6a5-4658-b296-18ca2606aaf8",
  :casting-time "1 action",
  :classes #{:wizard},
  :range :touch},
 "bd1ca125-5209-4155-b8b3-27910ed68068"
 {:description
  ...
  :components "V",
  :ritual "yes",
  :id "bd1ca125-5209-4155-b8b3-27910ed68068",
  :casting-time "1 minute",
  :classes #{:wizard :warlock},
  :range :self},
 "b38d2568-2355-419f-b39d-c6ec44fd321a"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "b38d2568-2355-419f-b39d-c6ec44fd321a",
  :casting-time "10 minutes",
  :classes #{:wizard},
  :range :self},
 "4d3aa062-fb1c-4415-82db-95f199aae394"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "4d3aa062-fb1c-4415-82db-95f199aae394",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :warlock},
  :range 120},
 "06c75300-f851-410d-8417-9805eff78c9c"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "06c75300-f851-410d-8417-9805eff78c9c",
  :casting-time "1 action",
  :classes #{:cleric :druid},
  :range 30},
 "77833e44-7793-4e8f-84f3-bfd3b40a412c"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "77833e44-7793-4e8f-84f3-bfd3b40a412c",
  :casting-time "1 action",
  :material-components "a holy symbol",
  :classes #{:cleric},
  :range :self},
 "997cc1ed-d82a-47e2-813f-4b50bb714bba"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "997cc1ed-d82a-47e2-813f-4b50bb714bba",
  :casting-time "1 minute",
  :classes #{:cleric :wizard :warlock :paladin},
  :range 10},
 "cc3a52fe-f601-4e24-b861-4bd6a4561431"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "cc3a52fe-f601-4e24-b861-4bd6a4561431",
  :casting-time "1 action",
  :classes #{:cleric :druid :sorcerer :wizard :warlock},
  :range :touch},
 "2a4714c3-2397-4fca-b45b-7e808aa63b2b"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "2a4714c3-2397-4fca-b45b-7e808aa63b2b",
  :casting-time "1 action",
  :material-components "a tiny ball of bat guano and sulfur",
  :classes #{:sorcerer :wizard},
  :range 150},
 "8acb319e-000f-4324-a9ee-a15084753506"
 {:description
 ...
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "cd081ecc-a2d7-4195-8ac4-753ef4de8c3e",
  :casting-time "1 action",
  :classes #{:cleric :sorcerer :wizard :bard},
  :range 30},
 "ad5e5502-acdd-4ffa-923b-875f07ffa16f"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ad5e5502-acdd-4ffa-923b-875f07ffa16f",
  :srd-name "Resilient Sphere",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 30},
 "cec075f1-a290-48c3-aece-ae3c47d942b7"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "cec075f1-a290-48c3-aece-ae3c47d942b7",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 60},
 "0ca5fec1-5e68-4101-a268-08257cb7114e"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "0ca5fec1-5e68-4101-a268-08257cb7114e",
  :casting-time "1 reaction",
  :classes #{:sorcerer :wizard},
  :range :self},
 "a59cd9bf-6694-41eb-bb4d-63b063a5c14d"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "a59cd9bf-6694-41eb-bb4d-63b063a5c14d",
  :casting-time "1 action",
  :classes #{:wizard :warlock},
  :range :self},
 "cded9448-502f-408e-b2d4-cf88076d11d8"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "cded9448-502f-408e-b2d4-cf88076d11d8",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 120},
 "54869c21-080f-49eb-882d-c57cb62ae185"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "54869c21-080f-49eb-882d-c57cb62ae185",
  :casting-time "1 bonus action",
  :classes #{:sorcerer :wizard :warlock},
  :range :self},
 "11662947-8073-4d1b-934d-90e6cbce846e"
 {:school :transmutation,
  :name "Flame Arrows",
  :concentration true,
  :duration "Concentration, 1 hour",
 ...
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "beedd7f1-1a25-492e-88d0-cf0847e5acdb",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 60},
 "147e26b2-fec4-431c-ad9e-e05890350edd"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "147e26b2-fec4-431c-ad9e-e05890350edd",
  :casting-time "1 bonus action",
  :material-components "a small silver mirror",
  :classes #{:cleric},
  :range 30},
 "57cb2ea4-2443-42fd-a06c-e956747c5f8b"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "57cb2ea4-2443-42fd-a06c-e956747c5f8b",
  :casting-time "1 hour",
  :classes #{:druid :wizard},
  :range 60},
 "3225f794-010e-45ab-92c3-0f11362e5310"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "3225f794-010e-45ab-92c3-0f11362e5310",
  :casting-time "1 minute",
  :material-components
  ...
  :classes #{:cleric :druid :bard},
  :range :self},
 "8d370ab4-7cca-49a7-a37d-0621255c1e1e"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "8d370ab4-7cca-49a7-a37d-0621255c1e1e",
  :casting-time "10 minutes",
  :classes #{:cleric :sorcerer :wizard :bard},
  :range 1},
 "765de362-0ab6-42fc-8b89-d986d192cbdc"
 {:school :transmutation,
  ...
  :components "VSM",
  :ritual "no",
  :id "765de362-0ab6-42fc-8b89-d986d192cbdc",
  :casting-time "1 action",
  :classes #{:ranger},
  :range 5},
 "74f65a70-e03c-4be0-ae8b-9a32c6874268"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "74f65a70-e03c-4be0-ae8b-9a32c6874268",
  :casting-time "1 minute",
  :material-components
  ...
  :classes #{:wizard :warlock},
  :range 30},
 "6d54cc1d-3ae2-4722-80bc-d499f8e61e5b"
 {:school :abjuration,
  ...
  :components "VS",
  :ritual "no",
  :id "6d54cc1d-3ae2-4722-80bc-d499f8e61e5b",
  :casting-time "1 action",
  :classes #{:druid},
  :range :self},
 "aaa00ea3-a3bb-44ce-a435-a03bca6d3f7c"
 {:description
 ...
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "bef363bb-b3a8-4355-b853-d92a5c4b1062",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range :self},
 "569f250d-c8b7-4ec8-94ce-1f6cb530d3dd"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "569f250d-c8b7-4ec8-94ce-1f6cb530d3dd",
  :casting-time "1 action",
  :classes #{:ranger :wizard :bard},
  :range :touch},
 "a4636e73-8168-4ade-9eb5-750e75e9df16"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "a4636e73-8168-4ade-9eb5-750e75e9df16",
  :casting-time "1 minute",
  :classes #{:cleric :wizard},
  :range 10},
 "b0873c77-cae6-489a-a2e5-77827aba5690"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "b0873c77-cae6-489a-a2e5-77827aba5690",
  :casting-time "1 action",
  :classes #{:druid},
  :range 30},
 "cc59f7e2-0761-4eca-9eca-86c592d3f17a"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "cc59f7e2-0761-4eca-9eca-86c592d3f17a",
  :casting-time "1 action",
  :material-components "a bit of fleece",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 120},
 "30ee5d1a-a416-4e39-8590-e32809f9c1f9"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "30ee5d1a-a416-4e39-8590-e32809f9c1f9",
  :casting-time "1 action",
  :classes #{:druid},
  :range 10},
 "845a4092-cb6f-4aed-9b07-3eab6e3ccb69"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "845a4092-cb6f-4aed-9b07-3eab6e3ccb69",
  :srd-name "Floating Disk",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 30},
 "94ad8c84-09fa-4ad3-820f-0330ea321ce4"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "94ad8c84-09fa-4ad3-820f-0330ea321ce4",
  :casting-time "1 action",
  :material-components
  "a glass or crystal bead that shatters when the spell ends",
  :classes #{:sorcerer :wizard},
  :range :self},
 "3259c33f-2e87-4b4f-b2ef-5fd26f02a3bb"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "3259c33f-2e87-4b4f-b2ef-5fd26f02a3bb",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 1},
 "eefa2d0a-5e11-4df6-99ba-918057ed9e54"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "eefa2d0a-5e11-4df6-99ba-918057ed9e54",
  :casting-time "1 minute",
  :material-components "a prayer wheel and holy water",
  :classes #{:cleric :druid :bard},
  :range :touch},
 "d4d1339e-9799-4630-afaf-c58ed61927c3"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "d4d1339e-9799-4630-afaf-c58ed61927c3",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 60},
 "4d29b534-7e1f-456f-89a3-de10bad10190"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "4d29b534-7e1f-456f-89a3-de10bad10190",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range 60},
 "3d24655b-bca0-4c4d-8a9a-4c47877bc96d"
 {:school :evocation,
  ...
  :components "VSM",
  :ritual "no",
  :id "3d24655b-bca0-4c4d-8a9a-4c47877bc96d",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 150},
 "c8f27863-5616-4691-b1a0-2e0e70a6575d"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "c8f27863-5616-4691-b1a0-2e0e70a6575d",
  :casting-time "1 action",
  :classes #{:cleric :bard},
  :range 60},
 "047f9cfe-59fc-4974-886a-4cc76c13cbc0"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "047f9cfe-59fc-4974-886a-4cc76c13cbc0",
  :casting-time "1 action",
  :classes #{:druid :ranger :bard},
  :range 150},
 "f9508513-0be4-40f5-804f-6f8ab8a542ba"
 {:description
 ...
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "4e7918f5-0ff2-4c54-bf77-e94323e0e9e0",
  :casting-time "1 action",
  :classes #{:druid :ranger :bard},
  :range 30},
 "4aa2367c-7633-4fef-b2e6-8dcb666949a2"
 {:description
  ...
  :components "VM",
  :ritual "no",
  :id "4aa2367c-7633-4fef-b2e6-8dcb666949a2",
  :casting-time "1 action",
  :material-components
  "a snake's tongue and either a bit of honeycomb or a drop of sweet oil",
  :classes #{:sorcerer :wizard :warlock :bard},
  :range 60},
 "a41b4bd5-ba54-4e4d-9f44-1988edc7ab12"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "a41b4bd5-ba54-4e4d-9f44-1988edc7ab12",
  :casting-time "1 action",
  :classes #{:druid :wizard :warlock :bard},
  :range 150},
 "bed9a4b8-eb58-4ac4-beeb-534d28b49e0b"
 {:school :necromancy,
  ...
  :components "VS",
  :ritual "no",
  :id "bed9a4b8-eb58-4ac4-beeb-534d28b49e0b",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 60},
 "12fe22cb-8b23-47d4-b96c-abba976481a5"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "12fe22cb-8b23-47d4-b96c-abba976481a5",
  :casting-time "1 action",
  :classes #{:wizard :warlock :bard},
  :range 60},
 "8c3a7e2c-695b-456c-9942-b4b883e23cac"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "8c3a7e2c-695b-456c-9942-b4b883e23cac",
  :casting-time "1 action",
  :classes #{:bard},
  :range 60},
 "f0510984-c0ce-4a3c-b743-6d0972603a53"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "f0510984-c0ce-4a3c-b743-6d0972603a53",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger :paladin :bard},
  :range :touch},
 "ea7516b4-f6dd-4e55-ab5e-d51f5c401c0f"
 {:school :evocation,
  :name "Frostbite",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VS",
  :ritual "no",
  :id "ea7516b4-f6dd-4e55-ab5e-d51f5c401c0f",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range 60},
 "1c5aecda-60fd-4514-bd73-5d1bbb35eb1f"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "1c5aecda-60fd-4514-bd73-5d1bbb35eb1f",
  :casting-time "1 action",
  :classes #{:cleric :sorcerer :wizard :warlock :bard},
  :range :self},
 "c62e4b67-96fd-4f18-b33f-d090d0bf8532"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "c62e4b67-96fd-4f18-b33f-d090d0bf8532",
  :srd-name "Secret Chest",
  :casting-time "1 action",
  :classes #{:wizard},
  :range :touch},
 "c3c9ba1f-b49e-4d2e-a5ae-744c71e5f1f4"
 {:description
  ...
  :components "VSM",
  :ritual "yes",
  :id "c3c9ba1f-b49e-4d2e-a5ae-744c71e5f1f4",
  :srd-name "Tiny Hut",
  :casting-time "1 minute",
  :classes #{:wizard :bard},
  :range :self},
 "ef201666-f90e-4ce2-b509-aac9ba009298"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "ef201666-f90e-4ce2-b509-aac9ba009298",
  :casting-time "1 action",
  :classes #{:wizard :bard},
  :range :touch},
 "d3c23eed-a019-49f7-a0b6-3a83b75ee08d"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "d3c23eed-a019-49f7-a0b6-3a83b75ee08d",
  :casting-time "1 action",
  :material-components
  ...
  :classes #{:cleric},
  :range :self},
 "aa672696-5fe9-406c-b8a7-316650f275e0"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "aa672696-5fe9-406c-b8a7-316650f275e0",
  :casting-time "1 reaction",
  :classes #{:warlock},
  :range 60},
 "6c0d32ea-d0f2-44c3-9d54-fc4aa9ba2a31"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "6c0d32ea-d0f2-44c3-9d54-fc4aa9ba2a31",
  :casting-time "1 action",
  :classes #{:cleric :paladin :bard},
  :range 60},
 "4de9da8a-a70c-4652-8968-5be5d11feb2c"
 {:school :transmutation,
  :name "Thorn Whip",
  :concentration false,
  :duration "Instantaneous",
  ...
  :components "VSM",
  :ritual "no",
  :id "4de9da8a-a70c-4652-8968-5be5d11feb2c",
  :casting-time "1 action",
  :classes #{:druid},
  :range 30},
 "1c46f457-8699-492a-8b6a-08276107a331"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "1c46f457-8699-492a-8b6a-08276107a331",
  :casting-time "1 action",
  :classes #{:cleric :druid :wizard},
  :range 300},
 "5b417bf3-3345-4d60-8448-54f799c8647f"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "5b417bf3-3345-4d60-8448-54f799c8647f",
  :casting-time "1 action",
  :classes #{:cleric :druid},
  :range :touch},
 "740b4d02-754c-4456-91f9-d67aeff2f9cb"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "740b4d02-754c-4456-91f9-d67aeff2f9cb",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 120},
 "93da1dbc-bc06-4895-a7e5-9e542a2c88e7"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "93da1dbc-bc06-4895-a7e5-9e542a2c88e7",
  :casting-time "1 action",
  :classes #{:druid :ranger :sorcerer :wizard},
  :range 120},
 "fcbc2906-0725-4572-9308-7b0dd1866917"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "fcbc2906-0725-4572-9308-7b0dd1866917",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 60},
 "07856cf4-35ae-470a-a3b2-3079691c9701"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "07856cf4-35ae-470a-a3b2-3079691c9701",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range :self},
 "3301bda4-78a5-486d-8c44-fe21c4cdf523"
 {:description
  ...
  :components "VSMgp",
  :ritual "yes",
  :id "3301bda4-78a5-486d-8c44-fe21c4cdf523",
  :casting-time "1 minute",
  :material-components
  "a pearl worth at least 100 gp and an owl feather",
  :classes #{:wizard :bard},
  :range :touch},
 "e5d0b0e6-506c-473c-8372-7e33deda445d"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "e5d0b0e6-506c-473c-8372-7e33deda445d",
  :casting-time "1 action",
  :classes #{:cleric :druid :sorcerer :wizard :warlock :paladin :bard},
  :range 120},
 "0fa6c4e9-67e8-40b6-be74-124ba8d86749"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "0fa6c4e9-67e8-40b6-be74-124ba8d86749",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range 150},
 "b1f81130-c954-4177-8e57-0bbc3102044a"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "b1f81130-c954-4177-8e57-0bbc3102044a",
  :casting-time "1 action",
  :classes #{:druid :ranger},
  :range :touch},
 "2222e7da-419c-4152-aeb1-b37f7d0745cb"
 {:description
  ...
  :components "VM",
  :ritual "no",
  :id "2222e7da-419c-4152-aeb1-b37f7d0745cb",
  :casting-time "1 action",
  :classes #{:cleric :sorcerer :wizard :warlock :bard},
  :range :touch},
 "bde3e511-d0be-4529-8497-4e49ff69eb6c"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "bde3e511-d0be-4529-8497-4e49ff69eb6c",
  :casting-time "1 action",
  :classes #{:cleric},
  :range 5},
 "c3ccd85f-8141-4ad3-bd55-59a51798c1ff"
 {:description
  ...
  :components "VMgp",
  :ritual "no",
  :id "c3ccd85f-8141-4ad3-bd55-59a51798c1ff",
  :casting-time "1 minute",
  :classes #{:sorcerer :wizard :bard},
  :range 10},
 "f7cc174b-7615-4e02-b229-0ea39fa9ef81"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "f7cc174b-7615-4e02-b229-0ea39fa9ef81",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range 10},
 "f1657ade-eab5-48c1-b944-b8daecff517c"
 {:school :transmutation,
  :name "Magic Stone",
  :concentration false,
  :duration "1 minute",
  ...
  :components "VS",
  :ritual "no",
  :id "f1657ade-eab5-48c1-b944-b8daecff517c",
  :casting-time "1 bonus action",
  :classes #{:druid :warlock},
  :range :touch},
 "37ca70bd-d7c2-41fc-9396-238824fa8dcf"
 {:description
  ...
  :components "V",
  :ritual "no",
  :id "37ca70bd-d7c2-41fc-9396-238824fa8dcf",
  :casting-time "1 minute",
  :classes #{:cleric :druid :wizard :paladin :bard},
  :range 60},
 "db098c43-471c-4188-927a-3ba10210bb02"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "db098c43-471c-4188-927a-3ba10210bb02",
  :casting-time "1 action",
  :classes #{:druid :wizard},
  :range :self},
 "dfab2208-12ef-41e1-971f-17cdd3e6a348"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "dfab2208-12ef-41e1-971f-17cdd3e6a348",
  :casting-time "12 hours",
  :classes #{:wizard},
  :range :touch},
 "35e2f56f-1618-4b0a-96f7-4df613e4a501"
 {:description
  ...
  :components "VSMgp",
  :ritual "no",
  :id "35e2f56f-1618-4b0a-96f7-4df613e4a501",
  :casting-time "1 action",
  :material-components
  "diamond dust worth at least 100 gp, which the spell consumes",
  :classes #{:cleric :druid :bard},
  :range :touch},
 "ab547a94-a8f7-42d5-8e19-83a22ac87422"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ab547a94-a8f7-42d5-8e19-83a22ac87422",
  :casting-time "1 action",
  :material-components
  "a pinch of fine sand, rose petals, or a cricket",
  :classes #{:sorcerer :wizard :bard},
  :range 90},
 "f9a15a72-0c49-4d28-aedc-83c34aa4d1ec"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "f9a15a72-0c49-4d28-aedc-83c34aa4d1ec",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 60},
 "c78b3a78-675b-4eb9-80c9-d639e3b39281"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "c78b3a78-675b-4eb9-80c9-d639e3b39281",
  :casting-time "1 bonus action",
  :classes #{:wizard :paladin},
  :range :touch},
 "02c883b3-144c-454a-9d32-d3bb27dcae17"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "02c883b3-144c-454a-9d32-d3bb27dcae17",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard :bard},
  :range :touch},
 "fce3b06d-1cc0-4ba6-ad32-eef526d57800"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "fce3b06d-1cc0-4ba6-ad32-eef526d57800",
  :casting-time "1 action",
  :material-components
  "a bit of fur; a piece of amber, glass, or a crystal rod; and three silver pins",
  :classes #{:sorcerer :wizard},
  :range 150},
 "dedb6c5a-f7b8-4335-a1b7-eda4e0947159"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "dedb6c5a-f7b8-4335-a1b7-eda4e0947159",
  :casting-time "1 action",
  :classes #{:wizard},
  :range 120},
 "4e05681f-55ee-410e-b676-e78c832b1be2"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "4e05681f-55ee-410e-b676-e78c832b1be2",
  :casting-time "1 action",
  :classes #{:cleric :wizard :warlock :paladin},
  :range :touch},
 "b589d7dc-74b6-46e4-b460-3ed639e0f7fe"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "b589d7dc-74b6-46e4-b460-3ed639e0f7fe",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range :self},
 "207e7d6f-c433-4399-93d4-2bcbbad2c919"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "207e7d6f-c433-4399-93d4-2bcbbad2c919",
  :casting-time "1 action",
  :classes #{:cleric :druid :ranger :paladin :bard},
  :range :touch},
 "629b88f2-d20d-4572-bb4b-f2cac1c9bd33"
 {:school :transmutation,
  ...
  :components "VS",
  :ritual "no",
  :id "629b88f2-d20d-4572-bb4b-f2cac1c9bd33",
  :casting-time "1 action",
  :classes #{:druid :sorcerer :wizard :warlock},
  :range :self},
 "9f5b5f4f-37a9-478d-b4dd-772bdf20e7f5"
 {:description
  ...
  :components "VS",
  :ritual "no",
  :id "9f5b5f4f-37a9-478d-b4dd-772bdf20e7f5",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard},
  :range 60},
 "ad3e11ad-f00b-485d-a809-ce6cf501ca9c"
 {:description
  ...
  :components "VSM",
  :ritual "no",
  :id "ad3e11ad-f00b-485d-a809-ce6cf501ca9c",
  :casting-time "1 action",
  :classes #{:sorcerer :wizard}, 
  :range :self}})
...
(defmulti key-value-translator
  (fn [k v] k))

(defmethod key-value-translator :default
  [k v]
  (hash-map k v))

(defmethod key-value-translator :class
  [_ v]
  (hash-map :classes (reduce
                       (fn [s k]
                         (conj s (key->keyword k)))
                       #{}
                       v)))

(defmethod key-value-translator :level
  [k v]
  (hash-map k (cond
                (= v "Cantrip") 0
                :else (js/parseInt v))))

(defmethod key-value-translator :range
  [k v]
  (let [n (js/parseInt v)]
    (hash-map k (cond
                  (js/isNaN n) (key->keyword v)
                  :else n))))

(defmethod key-value-translator :school
  [k v]
  (hash-map k (key->keyword v)))

(defmethod key-value-translator :concentration
  [k v]
  (hash-map k (= v "yes")))

(defmethod key-value-translator :_keys [_ _])
(defmethod key-value-translator :card [_ _])
                ...
                (merge
                  ...
                  (key-value-translator
                    ...
                    (-> json
                        ...
                        (gobj/get p)))))
              (hash-map :id uuid)
              (js/Object.keys (gobj/get json k)))))))
  {}
  (js/Object.keys json)))
